...
Determine if the hotel revenue is growing overall.
Analyze hotel revenue growth by year to identify trends and patterns.
Assess the need to increase the parking lot size based on the trend of guests with personal cars.
Explore additional trends in the data, with a focus on average daily rate and guest patterns to uncover seasonality effects.
Tools Used
...
Connect Power BI to the SQL Server database and import the relevant tables.
Create visualizations in Power BI to analyze hotel revenue growth, guest occupancy patterns, parking lot size, average daily rate, and other trends.
Conclusion
